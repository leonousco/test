...
<body>
  ...
  <div id=footer class="footer"></div>
    ...
    <script src="resources/js/oid/model/Nis.Model.OIDBase.js"></script>
    <script src="resources/js/oid/model/Nis.Model.OID.js"></script>
    ...
    <script src="resources/js/oid/manager/app/view/OIDListLayout.js"></script>
    <script src="resources/js/oid/manager/app/view/OIDReqManager.js"></script>
    <script src="resources/js/oid/manager/app/view/UserModifyLayout.js"></script>
    <script src="resources/js/oid/manager/app/view/OrgInfoLayout.js"></script>
    <script src="resources/js/oid/manager/app/view/OrgModifyLayout.js"></script>
    <script src="resources/js/oid/manager/app/view/UserModifyLayout.js"></script>

    <script src="resources/js/oid/uiinfo/Nis.UIInfo.Buttons.js"></script>
    <script src="resources/js/oid/manager/app/NisMVC.Router.js"></script>
