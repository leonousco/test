...
<head>
  ...
  <link href="resources/css/nis/backgrid.css" rel="stylesheet">
  <link href="resources/css/nis/NHP.css" rel="stylesheet">
  <link href="resources/css/nis/jstree/style.css" rel="stylesheet">
  <link href="resources/css/nis/jstree/themes/proton/style.css" rel="stylesheet">
...
<body>
  ...
  <div id=footer class="footer"></div>
    ...
    <script src="resources/js/lib/nis/jstree.js"></script>
    ...
    <script src="resources/js/nis/model/Nis.Model.OIDBase.js"></script>
    <script src="resources/js/nis/model/Nis.Model.OID.js"></script>        
    ...
    <script src="resources/js/nis/view/UserSearchControl.js"></script>
    <script src="resources/js/nis/view/OrgSearchControl.js"></script>
    <script src="resources/js/nis/view/OIDSearchControl.js"></script>
    ...
    <script src="resources/js/oid/model/Nis.Model.OIDRequest.js"></script>
    <script src="resources/js/oid/model/Nis.Model.OrgRequest.js"></script>    
    <script src="resources/js/oid/model/Nis.Model.MPerson.js"></script>  


    <script src="resources/js/oid/client/app/view/OIDListLayoutClient.js"></script>
    <script src="resources/js/oid/client/app/view/OIDrequestLayout.js"></script>
    <script src="resources/js/oid/client/app/view/OIDMain.js"></script>
    <script src="resources/js/oid/client/app/view/OIDNode.js"></script>

    <script src="resources/js/oid/uiinfo/Nis.UIInfo.Buttons.js"></script>


    <script src="resources/js/oid/view/MPersonSearchControl.js"></script>
    <script src="resources/js/oid/client/app/view/OrgInfoLayoutClient.js"></script>
    <script src="resources/js/oid/client/app/view/MPersonMgrLayout.js"></script>
   <script src="resources/js/oid/client/app/view/UserMgrLayout.js"></script>

    <script src="resources/js/oid/client/app/NisMVC.Router.js"></script>
