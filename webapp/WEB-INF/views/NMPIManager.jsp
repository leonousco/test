...
<body>
  ...
  <div id=footer class="footer"></div>
    ...
    <script src="resources/js/nis/view/ConfirmBased.js"></script>
    ...
    <script src="resources/js/nis/app/NisMVC.ManagerController.js"></script>
    ...
    <script src="resources/js/nmpi/manager/app/view/HasMPISearchControl.js"></script>
    <script src="resources/js/nmpi/manager/app/view/MainTopLayout.js"></script>
    <script src="resources/js/nmpi/manager/app/view/PatientTop.js"></script>
    <script src="resources/js/nmpi/manager/app/view/PatientMiddle.js"></script>
    <script src="resources/js/nmpi/manager/app/view/Patient.js"></script>


    <script src="resources/js/nmpi/manager/app/view/HospitalTop.js"></script>
    <script src="resources/js/nmpi/manager/app/view/HospitalMiddle.js"></script>
    <script src="resources/js/nmpi/manager/app/view/HospitalBottom.js"></script>
    <script src="resources/js/nmpi/manager/app/view/Hospital.js"></script>


    <script src="resources/js/nmpi/manager/app/view/MpiTop.js"></script>
    <script src="resources/js/nmpi/manager/app/view/MpiMiddle.js"></script>
    <script src="resources/js/nmpi/manager/app/view/Mpi.js"></script>
    <script src="resources/js/nmpi/manager/app/view/UserMgrLayout.js"></script>

    <script src="resources/js/nmpi/manager/app/NisMVC.Router.js"></script>
