...
(function () {
    ...
    Nis.View.RequestDropManagement = Uic.LayoutView.extend({
        className:'col-sm-12',
        id:'page_contents',
        regions: {
            header: '#page-title',
        ...
        showTitle:function() {
            var view = new Uic.View({raw:'<h3>탈퇴 요청</h3>'});
        ...
        onConceptSetButtons:function(id, text, button) {
            ...
            switch(id) {
                case 'approvalDrop': {
                    console.log("approvalDrop btn clicked");
                    break;
                }
            };
        },
        ...
        onSearchButtonClick:function(buttons, inputBox){
            ...
            this.table.collection.searchData(options, this.keyword, "DELETE");
        },
