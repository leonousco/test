...
(function () {
    ...
    Nis.Model.ManagerCheckFormUi = Nis.UiInfo.extend ({
        ...
        getInfo:function(options) {
            ...
            ret.raw =
                ...
                +           '<div class="col-sm-2"><input id="id" type="text" class="form-control" readonly></input></div>'            
                ...
                +           '<div class="col-sm-4"><input id="userName" type="text" class="form-control"></input></div>'                
                ...
                +           '<div class="col-sm-4"><input id="passWord" type="password" class="form-control"></input></div>'                
                ...
                +           '<div class="col-sm-2">'
                +                  '<select id = "countryCode" name="countryCode" class="form-control"><option value="KO" selected>KO</option><option value="US">US</option></select>'
                +           '</div>'       
                +      '</div>'
                +     '<div id="<%= formGroupId %>" class="form-group">'
                ...
                +           '<div class="col-sm-1"><input id="phoneNumber2" type="text" class="form-control" maxlength="4" size="4"></input></div>'
                +           '<div style="width:1%;float: left;" >-</div>'                
                +           '<div class="col-sm-1"><input id="phoneNumber3" type="text" class="form-control" maxlength="4" size="4"></input></div>'                
                ...
                +           '<div class="col-sm-2"><input id="email1" type="text" class="form-control"></input></div>'
                +           '<div style="width:1%;float: left;" >@</div>'                
                +           '<div class="col-sm-2"><input id="email2" type="text" class="form-control"></input></div>'   
                +           '<div class="col-sm-2">'
                ...
                +      '</div>'
                +     '<div id="<%= formGroupId %>" class="form-group">'
                +         '<label for="enabled" class="col-sm-1 control-label">토큰허용</label>'
                +           '<div class="col-sm-2"><select id = "enable" name="enable" class="form-control"><option value="1" selected>허용</option><option value="0">허용하지않음</option></select></div>'                
                +      '</div>'
                +     '<div id="<%= formGroupId %>" class="form-group">'
                +         '<label for="address" class="col-sm-1 control-label">주소</label>'
                +           '<div class="col-sm-2"><input id="postalCode" type="text" class="form-control"></input></div>'
                ...
                +           '<div class="col-sm-6"><input id="city" type="text" class="form-control"></input></div>'                
                +      '</div>'
                +     '<div id="<%= formGroupId %>" class="form-group">'
                +         '<label for="address3" class="col-sm-1 control-label"></label>'
                +           '<div class="col-sm-6"><input id="address" type="text" class="form-control"></input></div>'                
                +      '</div>'                      
